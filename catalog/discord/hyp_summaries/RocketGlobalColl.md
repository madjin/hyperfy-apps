...
## Discord Context
> i have this rocket, the latest version.

## Blueprint
- **Name**: Rocket(Global+Coll)
- **Version**: 1
- **Model**: `asset://788e6699bceb35532b536d4f4ac8d5caf54e3578d82ea95ee94f9bdfbbcf6b93.glb`
- **Script**: `asset://43eef9fd7efd54c2977b04fbcef0735360e21e19de10cc91238dff47cddc8376.js`

## Assets
- `[model]` 788e6699bceb35532b536d4f4ac8d5caf54e3578d82ea95ee94f9bdfbbcf6b93.glb (61,500 bytes)
- `[script]` 43eef9fd7efd54c2977b04fbcef0735360e21e19de10cc91238dff47cddc8376.js (5,313 bytes)

## Script Analysis
**App Methods**: `app.create()`, `app.get()`, `app.on()`, `app.send()`
**World Methods**: `world.getTime()`
**Events Listened**: `rocketCancel`, `rocketLaunch`, `rocketParticlesStop`, `rocketRespawn`, `rocketStart`, `update`
**Nodes Created**: `action`, `particles`

## Keywords (for Discord search)
acceleration, action, active, additive, again, alphaOverLife, animation, animations, blending, broadcasts, cancel, clients, clone, command, complete, correctly, create, data, delta, direction
...
---
*Extracted from RocketGlobalColl.hyp. Attachment ID: 1437796842350968912*