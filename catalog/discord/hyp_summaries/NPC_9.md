...
- **Channel**: #💻│developers
- **Date**: 2025-03-25
- **Size**: 7,737,296 bytes

## Blueprint
- **Name**: NPC
- **Version**: 1
- **Model**: `asset://468eaa14d7fdc09b16c775d88253c74c2caa82c4866fb29e23d36779556288c1.vrm`
- **Script**: `asset://c98ab8d8eb2024e09b950b5e5d6ed636eabde62c9a4ab8673573e3396350f01a.js`
...
- `[script]` c98ab8d8eb2024e09b950b5e5d6ed636eabde62c9a4ab8673573e3396350f01a.js (6,350 bytes)
...
## Script Analysis
**App Methods**: `app.configure()`, `app.emit()`, `app.get()`, `app.on()`, `app.send()`
...
actual, after, anim, animButton, animUrl, animation, animations, appId, applyQuaternion, array, attack, attackAnim, attackAnimations, attackName, attackTimer, attacking, attacks, avatar, based, bone
...
---
*Extracted from NPC_9.hyp. Attachment ID: 1354068129331810354*