...
## Discord Context
> ok...
latest dev has new physics stuff for vehicles etc.
and here's the bones of a car, it needs some tuning.
its client-side only for now but i have a feeling you could fully simulate it all on the server and just send visuals to the client.

## Blueprint
- **Name**: car1
- **Version**: 643
- **Model**: `asset://f136ded61be11b617abfed7ba537dac2ea390b95f34a2d5c99a877b29dc29d9f.glb`
- **Script**: `asset://36e34b8cb25d5849372607b2c96d42e217480d1d5c5188cbdb3997f631bdc159.js`

## Assets
- `[model]` f136ded61be11b617abfed7ba537dac2ea390b95f34a2d5c99a877b29dc29d9f.glb (9,900 bytes)
- `[script]` 36e34b8cb25d5849372607b2c96d42e217480d1d5c5188cbdb3997f631bdc159.js (7,952 bytes)
...
accel, accelAmount, accelDir, accelerating, acceleration, addForceAtLocalPos, amount, anchor, angular, angularDamping, apply, applyEffect, applyQuaternion, attach, availableTorque, body, cMass, check, clamp, collider
...
---
*Extracted from car1.hyp. Attachment ID: 1353196234675851345*