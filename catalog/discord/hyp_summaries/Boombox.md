...
- **Channel**: #⚡│general
- **Date**: 2026-01-09
- **Size**: 2,977,743 bytes

## Discord Context
> here's a boombox that might help

## Blueprint
- **Name**: Boombox
- **Version**: 3
- **Model**: `asset://ai.glb`
- **Script**: `asset://7b6d18a8c5416d6eb6607176c297fb0b4af330984a9e80a92ea21757cf427adc.js`

## Props
- `prompt`: str = `old school boom box`
- `createdAt`: float = `61412.864976005`
- `audio`: audio → `asset://b07b750822f1dff0cfb934087594aa10130f7dd5059b3ac372dfe80ebc789aad.mp3`
- `volume`: float = `0.5`
- `audioDistance`: int = `7`
- `rolloffFactor`: int = `5`
- `isPlaying`: bool = `True`
...
- `[script]` 7b6d18a8c5416d6eb6607176c297fb0b4af330984a9e80a92ea21757cf427adc.js (8,692 bytes)
- `[audio]` b07b750822f1dff0cfb934087594aa10130f7dd5059b3ac372dfe80ebc789aad.mp3 (2,964,716 bytes)

## Script Analysis
**App Methods**: `app.add()`, `app.configure()`, `app.create()`, `app.get()`, `app.on()`, `app.remove()`, `app.send()`
**Events Listened**: `togglePlay`, `updatePlayState`, `updateProps`
**Nodes Created**: `action`, `audio`, `group`, `prim`

## Keywords (for Discord search)
action, antPivot, antenna, audio, audioDistance, avoid, bdbdbd, block, body, boolean, boombox, boomboxAudio, btnD, btnH, btnW, button, buttons, buttonsCount, cassetteD, cassetteDoor
...
if (world.isClient) {
  ...
  app.on('updatePlayState', data => {
    ...
    if (boomboxAudio) {
      ...
      } else if (!app.state.isPlaying && boomboxAudio.isPl

// ... truncated ...
```

---
*Extracted from Boombox.hyp. Attachment ID: 1459269670656933969*