...
## Discord Context
> it's wip, think i stripped the sounds out

## Blueprint
- **Name**: Eagles v1
- **Version**: 56
- **Model**: `asset://7a87d90650114b10a14d107042ffbefc1db0c395c992540964e9b58ce6b9c81c.glb`
- **Script**: `asset://03a500267429a1c1837aa36ea73c4bca291b00d12f494890ccb4061c6a61c439.js`
...
- `wingbeat_min`: int = `5`
- `wingbeat_max`: int = `10`
- `soarSpeed_min`: float = `0.5`
- `soarSpeed_max`: float = `1.5`
- `soundEnabled`: str = `true`
- `volume`: float = `0.02`
- `eagleSound`: audio → `asset://d94f8452f0ce345ec40707df23acc9d3ef431cec64890bd7604ddb41388fb934.mp3`
- `minHeight`: int = `20`
- `maxHeight`: int = `30`
- `speed`: int = `1`
- `refDistance`: int = `5`
- `maxDistance`: int = `50`
- `eagleSound2`: audio → `asset://cc87b066e1cb1433facfcf53b6a562702ee9c9556cbb3bfc81bbd8522e5e76f6.mp3`

## Assets
- `[model]` 7a87d90650114b10a14d107042ffbefc1db0c395c992540964e9b58ce6b9c81c.glb (11,780 bytes)
- `[script]` 03a500267429a1c1837aa36ea73c4bca291b00d12f494890ccb4061c6a61c439.js (9,602 bytes)
- `[audio]` d94f8452f0ce345ec40707df23acc9d3ef431cec64890bd7604ddb41388fb934.mp3 (49,065 bytes)
- `[audio]` cc87b066e1cb1433facfcf53b6a562702ee9c9556cbb3bfc81bbd8522e5e76f6.mp3 (53,693 bytes)
...
active, amount, angle, anytime, audio, baseHeight, beat, chance, clone, config, configure, console, container, copy, create, createEagle, currentHeight, decay, delta, descent
    ...
    eagles.forEach(eagle => {
      ...
      if (!eagle.flapping && Math.random() < 0.02) {
        ...
        if (eagleAudio && app.config.soundEnabled === 'true') {
          ...
          const volumeScale = (height - 10) / 

// ... truncated ...
```

---
*Extracted from Eagles_v1.hyp. Attachment ID: 1356075244028166254*