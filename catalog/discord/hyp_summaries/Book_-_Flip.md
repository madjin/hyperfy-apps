...
## Discord Context
> Plop this book down and press F to do a flip or use as a double jump.

## Blueprint
- **Name**: Book - Flip
- **Version**: 4
- **Model**: `asset://ai.glb`
- **Script**: `asset://7b5af9bf90dcb05513c6ffe49843fe6b1eb299fdd738a60afa0cdc3ee44bdca4.js`

## Props
- `prompt`: str = `a closed book standing up vertically`
- `createdAt`: float = `7485.845766458994`
- `rollEmote`: emote → `asset://2dd66d8373afa804d20dc00b831ecc161b1fb78192e00ffb9824832ac3a990fc.glb`
- `jumpStrength`: int = `2`
- `forwardStart`: int = `10`
- `forwardLand`: int = `20`
- `landDelay`: int = `500`
- `rollDuration`: int = `100`
- `hotkey`: str = `F`
- `jumpEmote`: emote → `asset://2dd66d8373afa804d20dc00b831ecc161b1fb78192e00ffb9824832ac3a990fc.glb`
- `flipEmote`: emote → `asset://2dd66d8373afa804d20dc00b831ecc161b1fb78192e00ffb9824832ac3a990fc.glb`

## Assets
- `[model]` ai.glb (3,380 bytes)
- `[script]` 7b5af9bf90dcb05513c6ffe49843fe6b1eb299fdd738a60afa0cdc3ee44bdca4.js (4,448 bytes)
- `[emote]` 2dd66d8373afa804d20dc00b831ecc161b1fb78192e00ffb9824832ac3a990fc.glb (85,768 bytes)
- `[emote]` 2dd66d8373afa804d20dc00b831ecc161b1fb78192e00ffb9824832ac3a990fc.glb (85,768 bytes)
- `[emote]` 2dd66d8373afa804d20dc00b831ecc161b1fb78192e00ffb9824832ac3a990fc.glb (85,768 bytes)

## Script Analysis
**App Methods**: `app.add()`, `app.configure()`, `app.control()`, `app.create()`, `app.get()`, `app.on()`, `app.remove()`
**World Methods**: `world.getPlayer()`
**Events Listened**: `update`
**Nodes Created**: `group`, `prim`

## Keywords (for Discord search)
action, after, applyEffect, applyImpulse, applyQuaternion, back, based, block, book, bookGroup, camera, canFlip, centerY, color, configure, configured, control, copy, cover, coverHeight
...
---
*Extracted from Book_-_Flip.hyp. Attachment ID: 1427292872750661694*