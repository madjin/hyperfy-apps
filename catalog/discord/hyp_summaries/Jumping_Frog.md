...
- **Version**: 2
- **Model**: `asset://ai.glb`
- **Script**: `asset://bdd36546fca4030284f29978c2a3a844c4342a7b4dde4aaca525f70640aca741.js`

## Props
- `prompt`: str = `make a weird jumping frog`
- `createdAt`: float = `5865.238252512004`

## Assets
- `[model]` ai.glb (3,380 bytes)
- `[script]` bdd36546fca4030284f29978c2a3a844c4342a7b4dde4aaca525f70640aca741.js (6,567 bytes)

## Script Analysis
**App Methods**: `app.add()`, `app.create()`, `app.get()`, `app.on()`, `app.remove()`
**Events Listened**: `animate`
**Nodes Created**: `group`, `prim`

## Keywords (for Discord search)
animate, apex, back, base, belly, bellyPatch, body, bodyR, bodyY, bulb, changelog, character, clamp, color, contact, create, crouch, cycles, cylinder, d6ffcf
...
---
*Extracted from Jumping_Frog.hyp. Attachment ID: 1461059470732951734*