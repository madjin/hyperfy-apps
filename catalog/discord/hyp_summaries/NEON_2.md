...
- **Channel**: #🎨│showcase
- **Date**: 2025-05-06
- **Size**: 1,373,928 bytes

## Blueprint
- **Name**: NEON_2
- **Version**: 11
- **Model**: `asset://c1bd83959a7c45f99f89b21eec28e00cfbd3e5e7eb7e77594d101da43d678da7.glb`
- **Script**: `asset://9fd75f091ad70c570759d10308bc52e0de205a482df36225e4495cf6cef18ad7.js`

## Props
- `text_input`: str = `** hyperfy **`
- `letter_spacing`: float = `2.5`
- `letter_scale`: int = `1`
- `emission_r`: float = `0.30000000000000004`
- `emission_g`: float = `0.7000000000000001`
- `emission_b`: float = `0.4`
- `emission_intensity`: int = `20`
- `.emissiveIntensity: 5`: float = `3.2`
- `showchars`: str = `true`
- `visible`: str = `false`
- `alignment`: str = `center`
- `scale`: float = `0.8`
- `height`: float = `2.3000000000000003`
- `uvcolor`: float = `0.45`
- `defaultVolume`: int = `1`
- `isSpatial`: bool = `True`
- `audioType`: str = `music`
...
- `maxDistance`: int = `20`
- `rolloffFactor`: int = `4`
- `audio`: audio → `asset://e7a5134244eba94ecfe5c636f3c281cc876c84dbc4794e5eb6afc7b877cde099.mp3`
- `audioPlayback`: str = `stop`

## Assets
- `[model]` c1bd83959a7c45f99f89b21eec28e00cfbd3e5e7eb7e77594d101da43d678da7.glb (1,167,488 bytes)
- `[script]` 9fd75f091ad70c570759d10308bc52e0de205a482df36225e4495cf6cef18ad7.js (7,011 bytes)
- `[audio]` e7a5134244eba94ecfe5c636f3c281cc876c84dbc4794e5eb6afc7b877cde099.mp3 (197,760 bytes)

## Script Analysis
**App Methods**: `app.add()`, `app.configure()`, `app.create()`, `app.get()`, `app.on()`, `app.remove()`
**Events Listened**: `config`
**Nodes Created**: `audio`

## Keywords (for Discord search)
active, alignment, ampersand, asterisk, audio, audioPlayback, audioSection, audioType, based, becomes, bracketLeft, bracketRight, center, changes, char, character, characters, clone, cloned, clonedMeshes
...
---
*Extracted from NEON_2.hyp. Attachment ID: 1369292993231851604*