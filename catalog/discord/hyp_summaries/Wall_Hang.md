...
## Discord Context
> It's a wip. It needs a bunch of additions still. Need to add animations to when you hit the wall, jumping up to the wall, jumping up from hanging, etc.

## Blueprint
- **Name**: Wall Hang
- **Version**: 403
- **Model**: `asset://97fc7289a38b5b49357e6fbd74e7e77fc78493dbb1c0dbc850cb8e9db9fd2530.glb`
- **Script**: `asset://99a3d8a0d1baf5fb49e673e9f1f8b95408be993a5114199d27033616589881b9.js`

## Props
- `collision`: bool = `True`
- `flipEmote`: emote → `asset://2dd66d8373afa804d20dc00b831ecc161b1fb78192e00ffb9824832ac3a990fc.glb`
- `hangingEmote`: emote → `asset://4fb4d34cb9559b033c27614ec2fbd6422e0b43d324d29a4154e89362582d5780.glb`

## Assets
- `[model]` 97fc7289a38b5b49357e6fbd74e7e77fc78493dbb1c0dbc850cb8e9db9fd2530.glb (3,380 bytes)
- `[script]` 99a3d8a0d1baf5fb49e673e9f1f8b95408be993a5114199d27033616589881b9.js (6,048 bytes)
...
- `[emote]` 4fb4d34cb9559b033c27614ec2fbd6422e0b43d324d29a4154e89362582d5780.glb (112,660 bytes)
...
applyEffect, applyQuaternion, away, based, camera, cancel, cancellable, chest, chestY, climbImpulse, clone, conditions, configure, control, cooldownTime, copy, createLayerMask, currentEffect, currentPosition, direction
...
---
*Extracted from Wall_Hang.hyp. Attachment ID: 1437891700029788361*