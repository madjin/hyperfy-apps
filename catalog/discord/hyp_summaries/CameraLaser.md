...
- **Name**: Camera Laser
- **Version**: 20
- **Model**: `asset://ee671dcf20cd46c2057d40cbe1e2033088a92a61d5e23d0b1a84c86982862073.glb`
- **Script**: `asset://c65ba26e3d0eeb26270ab08a2e074a084a9475c6d4eff2fc6c6fc700d8e382a0.js`

## Assets
- `[model]` ee671dcf20cd46c2057d40cbe1e2033088a92a61d5e23d0b1a84c86982862073.glb (12,400 bytes)
- `[script]` c65ba26e3d0eeb26270ab08a2e074a084a9475c6d4eff2fc6c6fc700d8e382a0.js (5,542 bytes)

## Script Analysis
**App Methods**: `app.add()`, `app.control()`, `app.create()`, `app.get()`, `app.on()`, `app.send()`
**World Methods**: `world.add()`, `world.remove()`
**Events Listened**: `laser:cleanup`, `laser:fire`, `laser:spawn`, `update`
**Nodes Created**: `action`, `prim`

## Keywords (for Discord search)
action, active, activeLasers, after, applyQuaternion, beam, camera, cameraPos, cleanup, client, clients, clone, color, console, control, controls, copy, correction, create, crossVectors
...
---
*Extracted from CameraLaser.hyp. Attachment ID: 1425737415955320935*