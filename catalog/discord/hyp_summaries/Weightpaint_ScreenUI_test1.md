# Weightpaint_ScreenUI_test1.hyp
...
## Discord Context
> Have you see this? i haven't really worked on it since the initial test. The idea was to be able to just 'paint' a Forrest (sort of like weight painting particles in blender)

## Blueprint
- **Name**: Weightpaint_ScreenUI_test1
- **Version**: 60
- **Model**: `asset://3e5529b4966c387f21b3be6c4bbe5cff947897ee46c405f7ac254229ca1ff719.glb`
- **Script**: `asset://5113e58ecdec060ef18f8da4ed156371767c1643d83e55b76db5790699eb1680.js`

## Assets
- `[model]` 3e5529b4966c387f21b3be6c4bbe5cff947897ee46c405f7ac254229ca1ff719.glb (49,180 bytes)
- `[script]` 5113e58ecdec060ef18f8da4ed156371767c1643d83e55b76db5790699eb1680.js (10,760 bytes)

## Script Analysis
**App Methods**: `app.add()`, `app.control()`, `app.create()`, `app.get()`, `app.on()`, `app.remove()`
**World Methods**: `world.getPlayer()`, `world.on()`
**Events Listened**: `player`, `update`
**Nodes Created**: `ui`, `uitext`

## Keywords (for Discord search)
active, alignItems, alpha, already, appInitialized, appPos, array, author, available, avoid, axis, backgroundColor, baseColor, based, behavior, below, between, blue, borderRadius, borderWidth
...
---
*Extracted from Weightpaint_ScreenUI_test1.hyp. Attachment ID: 1420742160076111984*