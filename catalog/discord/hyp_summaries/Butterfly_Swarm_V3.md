...
## Blueprint
- **Name**: Butterfly Swarm V3
- **Version**: 122
- **Model**: `asset://f1b429aafb76cd7bbe3355ad8c013182ed0ff2aa859a2192d4968f08b306b00f.glb`
- **Script**: `asset://c9a6fcaa704d229e6348a1a88282dd7b221db9fa84216df4c6735f12b4af57c3.js`
...
- `[script]` c9a6fcaa704d229e6348a1a88282dd7b221db9fa84216df4c6735f12b4af57c3.js (9,071 bytes)
...
acts, adding, additional, amount, angle, animation, animations, around, array, axis, based, between, butterflies, butterfly, client, clone, cloned, clones, computed, config
...
app.remove(wingROriginal); // Remove original right wing
app.remove(wingLOriginal); // Remove original left wing
...
if (world.isClient) {
  app.on('update', (delta) => {
    butterflies.forEach(butterfly => {
      ...
      // --- Movement Animation ---
      // Compute oscillatory movement offs

// ... truncated ...
```

---
*Extracted from Butterfly_Swarm_V3.hyp. Attachment ID: 1350145490674782309*