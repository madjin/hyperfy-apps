...
## Discord Context
> TriggerZone - triggers when a player walks through, sends a message to discord when triggered.

## Blueprint
- **Name**: TriggerZone
- **Version**: 220
- **Model**: `asset://97fc7289a38b5b49357e6fbd74e7e77fc78493dbb1c0dbc850cb8e9db9fd2530.glb`
- **Script**: `asset://94b1511800cf5c4b9591b0c5a08a6030a165fd1ff4e635a01218479724dd169f.js`

## Props
- `collision`: bool = `True`
- `broadcastChat`: bool = `True`
- `triggerName`: str = `Trigger Zone`
- `showTrigger`: bool = `True`
- `triggerColor`: str = `#ff6ede`
- `triggerOpacity`: float = `0.49`
- `webhook`: str = ``
- `triggerSizeX`: int = `2`
- `triggerSizeY`: int = `2`
- `triggerSizeZ`: int = `2`
...
- `[script]` 94b1511800cf5c4b9591b0c5a08a6030a165fd1ff4e635a01218479724dd169f.js (10,284 bytes)

## Script Analysis
**App Methods**: `app.add()`, `app.configure()`, `app.create()`, `app.get()`, `app.on()`, `app.remove()`, `app.scale()`
**World Methods**: `world.add()`, `world.getPlayer()`
**Events Listened**: `config`, `update`
**Nodes Created**: `collider`, `prim`, `rigidbody`

## Keywords (for Discord search)
active, actual, actually, added, appPos, application, applied, automatically, available, avoid, axis, because, block, body, both, broadcast, broadcastChat, changed, changes, check
...
---
*Extracted from TriggerZone.hyp. Attachment ID: 1440323116084756635*